...
-- -----------------------------------------------------
-- Table `mayaweb`.`Pregunta`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mayaweb`.`Pregunta` ;

CREATE TABLE IF NOT EXISTS `mayaweb`.`Pregunta` (
  `idPregunta` INT NOT NULL AUTO_INCREMENT,
  `question` VARCHAR(300) NULL,
  `rutaImagen` VARCHAR(300) NULL,
  `numRespuesta` INT NULL,
  `comentario` VARCHAR(300) NULL,
  `opcion1` VARCHAR(150) NULL,
  `opcion2` VARCHAR(150) NULL,
  `opcion3` VARCHAR(150) NULL,
  `opcion4` VARCHAR(150) NULL,
  PRIMARY KEY (`idPregunta`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `mayaweb`.`opcion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mayaweb`.`opcion` ;

CREATE TABLE IF NOT EXISTS `mayaweb`.`opcion` (
  `idopcion` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(150) NULL,
  `Pregunta_idPregunta` INT NOT NULL,
  PRIMARY KEY (`idopcion`, `Pregunta_idPregunta`),
  INDEX `fk_opcion_Pregunta1_idx` (`Pregunta_idPregunta` ASC),
  CONSTRAINT `fk_opcion_Pregunta1`
    FOREIGN KEY (`Pregunta_idPregunta`)
    REFERENCES `mayaweb`.`Pregunta` (`idPregunta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
